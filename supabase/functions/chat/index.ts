    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `Você é o assistente do FocusLab, um app de desenvolvimento pessoal e produtividade. Responda SEMPRE em português do Brasil. Seja direto, motivador e prático.
